...
export default function Testimonials({ data }:{data: TestimonialsProp}) {
        ...
        <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <div className="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
            <div>
              ...
              <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-[#00F0FF]">99.99%</p>
            ...
            <div>
              ...
              <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-[#00F0FF]">5,000+</p>
              <p className="mt-1 text-gray-400">partner with Savest</p>
            </div>

            <div>
              <h4 className="text-lg sm:text-xl font-semibold text-white">Happy Clients</h4>
              <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-[#00F0FF]">98%</p>
