...
export const testimonies = [
  ...
  },
  {
    ...
    message:
      "I've had the privilege of working with Savest for some time now, and their professionalism and knowledge continue to impress me. They provide thoughtful advice tailored to my financial goals and risk tolerance. Savest's commitment to their clients' success is truly remarkable.",
  },
  {
    ...
    message:
      "Savest's financial expertise has been a game-changer for me. Their insights into market trends and their ability to explain complex concepts in simple terms have empowered me to make better financial decisions. Their services have exceeded my expectations in every way.",
  },
  {
    ...
    message:
      "Savest's commitment to their clients is truly commendable. Their dedication to achieving financial goals is evident in every interaction. Their insights have helped me navigate volatile markets with confidence, and their friendly approach makes discussing finances a breeze.",
  },
  {
    ...
    message:
      "Working with Savest has been enlightening. Their advice extends beyond mere financial matters; they're a holistic wealth advisor. Their personalized approach and genuine care for their clients' financial well-being are what set them apart. I'm grateful for their guidance.",
  },
  {
    ...
    message:
      "Savest's expertise stands out in a crowded financial landscape. Their knowledge of investment opportunities and risk management is unparalleled. They've not only helped me make informed decisions but also educated me along the way. I highly recommend their services.",
  },
  {
    ...
    message:
      "Savest is a financial wizard. Their ability to foresee market trends and recommend timely actions is remarkable. I've achieved significant growth in my investments under their guidance. They're not just financial advisors; they're strategic partners in wealth-building.",
  },
  {
    ...
    message:
      "I've been a client of Savest for years, and their dedication to my financial success has never wavered. Their well-rounded expertise covers everything from retirement planning to tax-efficient investing. They're an invaluable asset in securing my financial future.",
  },
  {
  ...
  },
  {
    ...
    message: "Savest has provided us with excellent financial advice and support. Their tailored services have greatly benefited our company. I can't recommend them enough.",
  },
  {
    title: 'Entrepreneur',
    name: 'Michael Johnson',
    imgUrl: 'https://images.pexels.com/photos/7083929/pexels-photo-7083929.jpeg?auto=compress&cs=tinysrgb&w=600',
    message: "Savest has been instrumental in my entrepreneurial journey. Their financial planning tools are top-notch and have helped me make informed decisions.",
  },
  {
    ...
    message: "Savest's platform is incredibly intuitive. Their support team is always ready to help. I've seen a significant improvement in my financial health since using their services.",
  },
  {
    ...
    message: "Managing employee benefits and finances has never been easier, thanks to Savest. Their comprehensive solutions are tailored to our needs and have made a huge difference.",
  },
  {
    ...
    message: "Savest offers incredible value for anyone serious about their finances. Their tools are precise, and their team is knowledgeable. I've been able to make better investment choices with their help.",
  },
  {
    title: 'Teacher',
    name: 'James Wilson',
    imgUrl: 'https://images.pexels.com/photos/3771839/pexels-photo-3771839.jpeg?auto=compress&cs=tinysrgb&w=600',
    message: "Savest's platform is user-friendly and has made managing my finances straightforward. I appreciate their transparency and the quality of their customer service.",
  },
  {
    ...
    message: "Working with Savest has been a game-changer for me. Their innovative solutions have streamlined my financial management and allowed me to focus more on my creative work.",
  },
  {
    ...
    message: "Savest's expertise in financial planning is unmatched. Their tools have given me a competitive edge in the real estate market. Highly recommend!",
  },
  {
    title: 'Consultant',
    name: 'Laura Garcia',
...
export const cmHero = {
  title: 'Commodities',
  subtitle:
    'Trade the most popular CFDs on Commodities from around the world, including energies, agriculture and metals. Savest combines tight pricing and flexible conditions to give you one powerful product.',
};

export const indicesHero = {
  title: 'Indices',
  subtitle:
    'Gain exposure to the basket of instruments making up the index in just one trade. The world’s most popular Indices are available on all Savest trading platforms.',
};
...
export const stocksHero = {
  title: 'Stocks',
  subtitle:
    'Trade over +2100 large-cap Stocks CFDs across the ASX, NYSE and NASDAQ stock exchanges with superior execution and tight pricing exclusively on the Savest MetaTrader 5 platform.',
};

export const futuresHero = {
  title: 'Futures',
  subtitle:
    "Futures are one of the most popular form of CFDs. Savest offer a range of Futures from around the world, including ICE Dollar Index and CBOE VIX Index. Online Futures based CFDs are offered exclusively on Savest ' MetaTrader 4 & 5 Platform.",
};
...
export const regHero = {
  title: 'Regulations',
  subtitle:
    'Savest is authorised and regulated by multiple Regulators across the globe. Trade with peace of mind knowing that Savest is monitored by some of the strictest financial regulators’ bodies in the world.',
};
...
export const serversHero = {
  title: 'Servers',
  subtitle:
    'Virtual Private Server (VPS) & Other Trading Servers allows traders to run automated trading strategies 24 hours a day 7 days a week with the fastest possible connectivity to the Savest trading servers.',
};
...
export const condHero = {
  ...
  subtitle:
    'The Savest Trading environment offers the most aggressive pricing and flexible trading conditions globally. They are ideal for traders who demand the best execution quality and lowest spreads.',
};

export const spreadsHero = {
  title: 'Spreads',
  subtitle:
    'Savest ’ spreads are among the lowest across all major and minor currency pairs. In particular, our average EUR/USD spread* of 0.1 pips is one of the lowest in the world.',
};

export const hoursHero = {
  title: 'Trading Hours',
  subtitle:
    'At Savest there’s always a market for you to trade. Our dedicated specialists are available for you 24 hours a day, 5 days a week.',
};

export const swapHero = {
  title: 'Swap Rates',
  subtitle:
    'Savest swap rates are amongst the most competitive in the world. Maximise your overnight swap earnings or reduce your swap costs across our wide range of products.',
};
